                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <select name="role" id="role" required
                                        class="block w-full pl-10 py-2.5 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        <option value="admin"
                                            {{ old('role', $user->role) == 'admin' ? 'selected' : '' }}>Admin (Full
                                            Access)</option>
                                        <option value="teacher"
                                            {{ old('role', $user->role) == 'teacher' ? 'selected' : '' }}>Teacher
                                        </option>
            ...
            <div class="bg-white border border-gray-200 shadow-sm sm:rounded-lg">
                <div class="p-8">
                    <header class="mb-6 border-b border-gray-100 pb-5">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Ensure this account is using a long, random password to stay secure. Leave blank if you do
                    ...
                    <form method="POST" action="{{ route('manageUsers.update', $user->id) }}" class="space-y-6">
                        ...
                        <div
                            class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg border border-gray-200">
                            <div>
