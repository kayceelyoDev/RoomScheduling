            ...
            <div class="bg-white border border-gray-200 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8 text-gray-900">
                    ...
                    <div class="mb-6 border-b border-gray-100 pb-5">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Fill in the information below to provision a new account
                            for the system.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('manageUsers.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="email" class="block font-medium text-sm text-gray-700">Email
                                    Address</label>
                                <div class="relative mt-1">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                <label for="role" class="block font-medium text-sm text-gray-700">System
                                    Role</label>
                                <div class="relative mt-1">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div class="pt-4 mt-6 border-t border-gray-100">
                            <h4
                                class="text-sm font-bold text-gray-800 mb-4 flex items-center gap-1.5 uppercase tracking-widest">
                                <i data-lucide="lock" class="w-4 h-4 text-gray-400"></i> Security
                            </h4>

                            <div
                                class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <p class="mt-2 text-[11px] text-gray-500 italic">Ensure the password is at least 8
                                characters long.</p>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                            ...
                            <button type="submit"
                                class="inline-flex items-center px-6 py-2.5 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-md">
