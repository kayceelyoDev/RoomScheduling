<x-guest-layout>
    ...
    <div class="overflow-y-auto max-h-[60vh] pr-2 -mr-2 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-200 [&::-webkit-scrollbar-thumb]:rounded-full">
        
        <form method="POST" action="{{ route('register') }}" class="space-y-4 pb-2">
            @csrf
            ...
            <div class="pt-3">
                <x-primary-button class="w-full justify-center py-2.5 text-base shadow-indigo-100 shadow-lg">
